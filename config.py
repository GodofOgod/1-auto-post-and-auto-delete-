...
AUTHORIZED_USERS = list(map(int, os.environ.get("AUTHORIZED_USERS", "1397269319,6906650389,1489652480").split(",")))      #For Example 123456,123456
...
DEFAULT_CHANNELS = list(map(int, os.environ.get("DEFAULT_CHANNELS", "-1002399067702,-1001842318978").split(",")))      #-1001234567890,-1009876543210  For Example
